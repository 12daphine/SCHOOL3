...
import com.example.school.databinding.FragmentApplyBinding
...
class ApplyFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val myWebView: WebView =view.findViewById(R.id.apply_webView)
        ...
        myWebView.loadUrl("https://stjohnswakiso.com/apply")
